...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Gallery_vue__ = __webpack_require__(87);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_46c817f9_hasScoped_false_node_modules_vue_loader_lib_selector_type_template_index_0_Gallery_vue__ = __webpack_require__(96);
var disposed = false
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__js_bonsaicategories_js__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__js_itemexists_js__ = __webpack_require__(89);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__js_router_js__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__js_axios_get_js__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__js_pager_js__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__js_pagebtns_js__ = __webpack_require__(91);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__js_indexfinder_js__ = __webpack_require__(92);
//
//
//
//
...
var vcGalleryLeftNav1 = function vcGalleryLeftNav1() {
  ...
  methods: {
    checkCategory: function checkCategory() {
      ...
      if (categoryToCheck === "all") {
        ...
        this.activatePager();
      } else if (!Object(__WEBPACK_IMPORTED_MODULE_1__js_itemexists_js__["a" /* itemExists */])(categoryToCheck, __WEBPACK_IMPORTED_MODULE_0__js_bonsaicategories_js__["a" /* bonsaiCategories */])) {
        // console.log("404/revert to gallery/defaultItem");
        __WEBPACK_IMPORTED_MODULE_2__js_router_js__["a" /* router */].push({
          path: "/gallery/all"
        });
      } else {
    ...
    loadItems: function loadItems() {
      ...
      Object(__WEBPACK_IMPORTED_MODULE_3__js_axios_get_js__["a" /* axios_get */])(jsonUrl).then(function (response) {
        // pass to allItems before filtering
        _this.allItems = response.data.bonsai;
      }).then(function () {
        _this.checkCategory();
      });
    },
    filterItems: function filterItems() {
      ...
      filteredType = this.allItems.filter(function (el) {
        return el.species === _this2.currentCategory;
      });
    ...
    activatePager: function activatePager() {
      this.pg = null;
      this.pg = new __WEBPACK_IMPORTED_MODULE_4__js_pager_js__["a" /* default */]({
    ...
    setPageBtns: function setPageBtns() {
      ...
      for (var i = 0, l = this.pg.getTotalPages(); i < l; i++) {
        this.temp.push(Object(__WEBPACK_IMPORTED_MODULE_5__js_pagebtns_js__["a" /* pageBtns */])(i, l));
      }
    },
    ...
    setCurrentIndex: function setCurrentIndex(id) {
      this.currentIndex = Object(__WEBPACK_IMPORTED_MODULE_6__js_indexfinder_js__["a" /* indexFinder */])("id", id, this.currentItems);
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
  ...
  }, [_c('vcGalleryLeftNav1')], 1), _vm._v(" "), _c('div', {
    ...
    return _c('div', {
      ...
      on: {
        "click": function($event) {
          _vm.setCurrentIndex(i.id)
        }
      }
    }) : _vm._e(), _c('br'), _vm._v(" "), _c('p', [_vm._v(_vm._s(i.species) + " " + _vm._s(i.value))])])])
  }))]), _vm._v(" "), _vm._m(1)])])])])])]), _vm._v(" "), _c('footer', [_c('vcFooter')], 1)])])
}
